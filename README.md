...
| `JSTOR_API_SECRET`         | JWT secret for authenticating with JSTOR                                                                                                                                                                                                                            | `arbitrary-string`                  |
| `JSTOR_API_URL`            | URL of JSTOR API base url. Used to support jstor://{article_id} URIs.                                                                                                                                                                                               | `http://example.com/api`            |
